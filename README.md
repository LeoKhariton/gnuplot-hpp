...
1. [Изображение графика функции в декартовых координатах](#изображение-графика-функции-в-декартовых-координатах)
2. [Визуализация решения линейной системы](#визуализация-решения-линейной-системы)
